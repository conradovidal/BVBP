...
const services = [
  {
    ...
    idealFor: "Primeira conversa",
    tagline: "Clareza antes de agir",
    color: "bg-blue-500",
  },
  {
    slug: "sprint-otimizacao",
    title: "Sprint de Otimização",
    shortTitle: "Sprint",
    duration: "2 semanas",
    icon: Zap,
    focus: "Quick win",
  ...
  },
  {
    ...
    prerequisite: "Nenhum",
    result: "Cadência e papéis claros",
...
const ComparativoServicosPage = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "O Sprint resolve 1 fluxo em 2 semanas. O Programa aborda 2-3 fluxos e inclui governança para sustentar os resultados.",
    },
    {
      question: "Preciso fazer o Diagnóstico antes de tudo?",
      answer: "Recomendamos, mas não é obrigatório. Se você já tem clareza do gargalo, pode ir direto para o Sprint ou Gestão.",
    },
    {
