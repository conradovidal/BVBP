...
const ServicesPage = () => {
  ...
  const services = [{
    ...
    features: ["Entrevistas com pessoas-chave", "Mapeamento completo de um processo crítico", "Relatório executivo com gaps e oportunidades de economia", "Métricas para avaliar oportunidades de melhoria"],
